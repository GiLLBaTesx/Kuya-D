...
const stripePromise = loadStripe("pk_test_51MikdSFgaAkZ9gHU66CIwS56vjlhcG3qUCaRYbWrgwe5KcZ1DnOBBYP38dmyuawqLjYhC65CUbitRg3WAHglCSZM00O2YMUxR6");
                                ...
                                <tbody>
                                    ...
                                    {cart.map((item) => (
                                        <tr>
                                            ...
                                            <td>P {item.price * user.cart[item._id]}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </Table>
                            <div>
                                <h3 className="h4 pt-4">Total: P {user.cart.total}</h3>
                            </div>
                        </>
                    </Col>
                )}
